...
def get_tokenlizer(text_encoder_type):
    ...
    tokenizer = AutoTokenizer.from_pretrained(text_encoder_type, cache_dir = groundingdino_model_dir)
    return tokenizer


def get_pretrained_language_model(text_encoder_type):
    if text_encoder_type == "bert-base-uncased" or (os.path.isdir(text_encoder_type) and os.path.exists(text_encoder_type)):
        return BertModel.from_pretrained(text_encoder_type, cache_dir = groundingdino_model_dir)
    if text_encoder_type == "roberta-base":
        return RobertaModel.from_pretrained(text_encoder_type, cache_dir = groundingdino_model_dir)
